...
## descargar el proyecto github
    ...
    user1$ mkdir apps
    user1$ cd apps
    user1$ git clone https://github.com/jrodri92/Geolocation-P1-.git
    user1$ cd Geolocation-P1-
    user1$ npm install
...
https://github.com/dlemusg/appwebArticulosNodejs/blob/master/deploy-on-dca.md