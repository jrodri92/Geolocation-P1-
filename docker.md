...
## Descargar el proyecto github
      ...
      $ mkdir apps
      $ cd apps
      $ git clone https://github.com/jrodri92/Geolocation-P1-.git
      $ cd Geolocation-P1-
...
Se ejecuta el docker-compose dentro de la carpeta yourWay
...
#Basado en 
https://github.com/dlemusg/appwebArticulosNodejs/blob/master/deploy-on-docker.md